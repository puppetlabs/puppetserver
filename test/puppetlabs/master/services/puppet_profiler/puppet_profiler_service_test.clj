(ns puppetlabs.master.services.puppet-profiler.puppet-profiler-service-test
  (:import (com.puppetlabs.master PuppetProfiler))
  (:require [clojure.test :refer :all]
            [puppetlabs.master.services.puppet-profiler.puppet-profiler-service :refer :all]
            [puppetlabs.master.services.protocols.puppet-profiler :refer [get-profiler]]
