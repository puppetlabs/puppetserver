...
(defprotocol JRubyPuppetService
  ...
  (borrow-instance [this pool-desc]
  ...
  (return-instance [this pool-desc jrubypuppet-instance]
                   "Returns the JRubyPuppet interpreter back to the pool described by pool-desc.")

  (free-instance-count [this pool-desc]
                       "The number of free JRubyPuppet instances left in the
                       described pool."))
