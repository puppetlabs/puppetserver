...
(defproject puppetlabs/puppet-server "0.1.13-SNAPSHOT"
  ...
  :aliases {"gem" ["trampoline" "run" "-m" "puppetlabs.puppetserver.cli.gem" "--config" "./dev-resources/puppet-server.conf"]}
