...
* The `product` settings configure update checking and analytics data collection:
    ...
    * `check-for-updates`: If set to `false`, Puppet Server will not automatically check for updates, and will not send analytics data to Puppet. 
        ...
        * Data collection timestamp 
        ...
        Puppet requests this data as one of the many ways we learn about and work with our community. The more we know about how you use Puppet, the better we can address your needs. No personally identifiable information is collected, and the data we collect is never used or shared outside Puppet. 
