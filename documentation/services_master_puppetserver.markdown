...
If we don't provide a package for your system, you can run Puppet Server from source on any POSIX server with JDK 1.8 or 11. See [Running from Source](./dev_running_from_source.markdown) for more details.
